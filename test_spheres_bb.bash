...
do
   ...
   ./test_spheres_bb 0 $h 1.6 12 >> log.txt 2>&1
   ./test_spheres_bb 1 $h 1.6 12 >> log.txt 2>&1
   ./test_spheres_bb 2 $h 1.6 12 >> log.txt 2>&1
   ./test_spheres_bb 3 $h 1.6 12 >> log.txt 2>&1
   ./test_spheres_bb 4 $h 1.6 12 >> log.txt 2>&1
